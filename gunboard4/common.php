...
// login table 복사
$sql = " select * from {$g5['user_table']} where id ='".$id."'" ;
$result = sql_query($sql);

if(empty($result)){
    sql_query("insert INTO user (id, name, email,phone,address,etc) VALUES ($id1, $name1, $email1, $phone1, $address1, $etc1) ");
}
?>
